  ...
  <div class="flex tb">
    ...
    <div class="flex">
      <button class="flex items-center justify-center mt-4">
        <svg
          ...
          class="external-icon"
          viewBox="0 0 97 20"
          style="width: 70%; pointer-events: none; display: block; height: 70%"
          focusable="false"
        >
          <svg
            viewBox="0 0 97 20"
    ...
    <div class="flex items-end ml-72 rounded w-4/12">
      ...
      <input
        ...
        type="text"
        class="search rounded-l-full ml-6 py-2 px-4 leading-tight focus:outline-blue-500 focus:outline focus:-ml-4 focus:pl-14 border-2 z-10 w-full "
        placeholder="Search"
      />
      <button
        class="btn-search text-white font-bold py-2 px-4 rounded-r-full flex"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          enable-background="new 0 0 24 24"
